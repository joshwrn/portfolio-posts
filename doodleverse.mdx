...
<Image src="https://res.cloudinary.com/db4ddmnhg/image/upload/v1715153955/projects/DoodleVerse/place.png" alt={`Reddit r/place 2023`} width={1000} height={666} />
...
<CodeSnippet
language="tsx"
title="Converting 3d to 2d coordinates"
...
<CodeSnippet
language="tsx"
title="Using a raycaster to get the 3d point on the canvas"
...
On the client side, I listen for the brush stroke event and draw the stroke on the canvas.
