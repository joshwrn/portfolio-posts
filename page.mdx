...
mainVideo: 'https://www.youtube.com/embed/1QIv3wZ8y9E'
---
...
Instead of copying the same functionality, textures, and animations to each piece I created a wrapper component that accepts a mesh as a child.
  ...
  return (
    <Layout
      project={{
        title: 'Collaborative Board',
        description:
          'A collaborative whiteboard app built with React, Socket.io, and Node.js.',
